...
$(document).ready(function() {
	...
	$('#timerTwo')
		.countdown($('#timerTwo').attr("data-date")).on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime('' + '<div class="clock-box"><span class="simple">%-D</span>d  </div>' + '<div class="clock-box"><span class="simple"> %H</span>h  </div>' + '<div class="clock-box"><span class="simple"> %M</span>m  </div>'));
		});
